        ...
        stage('Push to JFrog') {
            steps {
                script {
                    ...
                    sh 'docker tag bprasad701/obs-java:latest http://3.235.133.9:8082/bhanu-docker-images/obs-java:latest'
                    sh 'docker login -u admin -p Vbp1993@gvr http://3.235.133.9:8082'
                    sh 'docker push http://3.235.133.9:8082/bhanu-docker-images/obs-java:latest'
                }
            }
        }
